...
// Event Bubbling
// In event bubbling, the event starts from the target element and bubbles upwards through
// its ancestors (parent → grandparent → etc.).
...
// instead of each child. It uses event bubbling to handle events from dynamically added or existing child elements.
